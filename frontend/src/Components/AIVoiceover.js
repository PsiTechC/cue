...
//           <div className="w-full max-w-lg -mt-8 flex space-x-2 mb-4">
//             <select
//               className="w-1/2 p-2 border border-gray-600 bg-[#1E1E1E] text-white text-lg rounded focus:outline-none font-normal cursor-pointer"
...
//           {/* Text Input */}
//           <textarea
//             className="w-full max-w-lg p-3 border border-gray-600 bg-white text-black text-lg rounded focus:outline-none"
...
//                 className="mt-4 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md text-sm"
//               >
//                 Download MP3
//               </a>
//             </>
